...
// const listDataItemsCart=getDataLocalStorage(keyLocalStorageItemsCart);
...
//   let cart=[];
//   let productPrice;
//   if (!listDataItemsCart) {
//       cart =[];
//       setDataLocalStorage(keyLocalStorageItemsCart, listData);
//   }
//   else if(listDataItemsCart){
//       cart=getDataLocalStorage(keyLocalStorageItemsCart)
//   }

//   for(let i=0;i<listDataItemsSP.length;i++){
//     if(listDataItemsSP[i].id===id){
//         productPrice=listDataItemsCart[i];
//     }
//   }
// }

// // click button thêm sp
// const btnAddCart=document.querySelectorAll('.home-product-item--icon');

// btnAddCart.forEach((cartItem)=>{
//   cartItem.addEventListener('click',addCart)
// })
