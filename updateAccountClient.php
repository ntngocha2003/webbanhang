<?php
    ...
    if(empty($diaChi)){
        ...
        $updateTK=" UPDATE `customers` SET `sdt`='$sdt',`image`='$image',
        `ngay_sinh`='$ngaySinh',`gioi_tinh`='$gioiTinh'WHERE id='$id' ";
    }
    else{
        $updateTK=" UPDATE `customers` SET `sdt`='$sdt',`image`='$image',
        `ngay_sinh`='$ngaySinh',`gioi_tinh`='$gioiTinh',`dia_chi`='$diaChi' WHERE id='$id' ";
    }
